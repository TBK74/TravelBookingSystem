                        ...
                        <div class="card tour-card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted small">
                                    ${tour.description.length() > 100 ? tour.description.substring(0, 100).concat('...') : tour.description}
                                </p>
                                ...
                                <div class="tour-info mb-3">
                                    ...
                                    <span class="badge bg-secondary">
                                        <i class="fas fa-map-marker-alt"></i> ${tour.location != null ? tour.location.name : ''}
                                    </span>
                                </div>
